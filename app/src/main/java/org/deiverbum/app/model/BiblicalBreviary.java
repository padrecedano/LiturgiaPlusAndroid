...
public class BiblicalBreviary extends Biblical {
    private BibleBook libro;
    ...
    public LHResponsoryShort getResponsorio() {
        return responsorio;
    }
    ...
    public SpannableStringBuilder getResponsorioHeader() {
        ...
        sb.append(Utils.toRed(String.format("%-15s", "LHResponsoryShort")));
