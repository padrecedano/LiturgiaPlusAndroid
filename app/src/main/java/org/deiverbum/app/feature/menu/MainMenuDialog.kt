...
@Composable
private fun ColumnScope.MainMenuPanel(
...
private fun ColumnScope.SettingsPanel(
    ...
    val menuItems = listOf(
        ...
        MenuItem(title = stringResource(R.string.feature_menu_settings), icon = LPlusIcons.Sync, 1),
        MenuItem(title = stringResource(R.string.feature_menu_bugs), icon = LPlusIcons.Sync, 1),
        MenuItem(title = stringResource(R.string.feature_menu_author), icon = LPlusIcons.Sync, 1),
        MenuItem(title = stringResource(R.string.feature_menu_about), icon = LPlusIcons.Sync, 1),
        MenuItem(title = stringResource(R.string.feature_menu_thanks), icon = LPlusIcons.Sync, 1),
        MenuItem(title = stringResource(R.string.feature_menu_new), icon = LPlusIcons.Sync, 1),
