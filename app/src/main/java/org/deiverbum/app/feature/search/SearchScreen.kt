...
import org.deiverbum.app.feature.search.RecentSearchQueriesUiState
import org.deiverbum.app.feature.search.SearchResultUiState
import org.deiverbum.app.feature.search.SearchUiStatePreviewParameterProvider
            ...
            if (recentSearchQueries.isNotEmpty()) {
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = "stringResource(searchR.string.feature_search_clear_recent_searches_content_desc,)",
    ...
    Row(
        ...
        IconButton(onClick = { onBackClick() }) {
            Icon(
                ...
                contentDescription = "stringResource(id = string.core_ui_back,)",
            )
        }
        SearchTextField(
            onSearchQueryChanged = onSearchQueryChanged,
    ...
    TextField(
        ...
        leadingIcon = {
            Icon(
                ...
                contentDescription = "stringResource(id = searchR.string.feature_search_title,)",
                tint = MaterialTheme.colorScheme.onSurface,
            )
        },
        trailingIcon = {
            if (searchQuery.isNotEmpty()) {
                IconButton(
                    ...
                    Icon(
                        imageVector = NiaIcons.Close,
                        contentDescription = "stringResource(id = searchR.string.feature_search_clear_search_text_content_desc,)",
                        tint = MaterialTheme.colorScheme.onSurface,
                    )
                }
            }
