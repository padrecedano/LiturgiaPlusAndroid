...
@Composable
internal fun InterestsScreenCopy(
...
@DevicePreviews
@Composable
fun InterestsScreenLoadingCopy() {
    NiaTheme {
        NiaBackground {
            InterestsScreen(
                uiState = TODO(),//InterestsUiState.Loading,
                followTopic = { _, _ -> },
                onTopicClick = {},
            )
        }
...
@DevicePreviews
@Composable
fun InterestsScreenEmptyCopy() {
    NiaTheme {
        NiaBackground {
            InterestsScreen(
                uiState = TODO(),//InterestsUiState.Empty,
                followTopic = { _, _ -> },
                onTopicClick = {},
            )
        }
