...
class Universalis(
    ...
    */
    ...
    val titulo: String
        get() = if (liturgyDay.typeID == 6) tituloVisperas else liturgy!!.name
    ...
    fun getAllForView(todayRequest: TodayRequest): SpannableStringBuilder {
        ...
        ssb.append(liturgy!!.theType.forView(timeFK, hasSaint == 1))
        ...
        try {
            ...
            if (liturgyDay.typeID == 0) {
                if (oBiblicalFK == 600010101) {
                    ...
                    sb.append(bh?.LHMixtus!!.forView(timeFK, hasSaintToday()))
                }
            }
            ...
            if (liturgyDay.typeID == 2) {
                sb.append(
                    ...
                    //    .getForView(timeFK, hasSaintToday())
                )
            }
    ...
    fun getAllForRead(hasInvitatory: Boolean): StringBuilder {
        ...
        //ssb.append(Utils.toH2(tiempo))
        //ssb.append(Utils.toH3(titulo))
        sb.append(liturgy!!.theType.forRead())
        ...
        try {
            ...
            if (liturgyDay.typeID == 2) {
                //sb.append(liturgyDay.breviaryHour!!.getLaudes()!!.forRead)
            }
            if (liturgyDay.typeID == 3 || liturgyDay.typeID == 4 || liturgyDay.typeID == 5) {
