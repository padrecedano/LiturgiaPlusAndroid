...
class LHOfficeOfReadingEaster(
    override var biblica: MutableList<LHOfficiumLectioPrior>,
    override var patristica: MutableList<LHOfficiumLectioAltera>,
    override var hasTeDeum: Boolean = false
) : LHOfficiumLectionis(biblica, patristica) {
    lateinit var lhPsalmody: LHPsalmody
    // lateinit var teDeum: LHPsalmody

    @Ignore

    lateinit var biblical: MutableList<LHOfficeBiblicalEaster>
        private set
