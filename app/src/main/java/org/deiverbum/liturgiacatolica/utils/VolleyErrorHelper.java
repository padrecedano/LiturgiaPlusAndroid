...
public class VolleyErrorHelper extends HtmlFormat {
    /**
    ...
    private static final String s_ErrorSinConexion = FONT_RED + "¡ERROR DE CONEXIÓN!" + _FONT + BRS + "No estás conectado a internet." + BR +
