...
import static org.deiverbum.liturgiacatolica.utils.Constants.CSS_B_A;
import static org.deiverbum.liturgiacatolica.utils.Constants.CSS_B_Z;
...
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.ADVIENTO;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.ALELUYA;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.ALELUYA_R;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.ANT_COMUNION;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.ANT_TITULO;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.EVANGELIO;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.LECTURA_1;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.LECTURA_2;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.L_EUCARISTICA;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.NO_CREDO;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.NO_GLORIA;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.O_COLECTA;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.O_COMUNION;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.O_DOMINICAL;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.O_FIELES;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.PLEGARIA;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.PREFACIO;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.R_COMUNION;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.R_INICIALES;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.SALMO_R;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.SI_CREDO;
import static org.deiverbum.liturgiacatolica.utils.MisaConstantes.SI_GLORIA;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            mTextView.setText(fromHtml(response));
                        }
                    }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                try {
                    ...
                    if (sMensaje != null && !sMensaje.isEmpty()) {
                        sb.append(sMensaje).append(BRS).append("<hr>");
                    }
        ...
        for (int i = 0; i < palabraArray.length(); i++) {
            ...
            switch (nOrden) {
                ...
                case 2:
                    ...
                    sb.append(CSS_RED_A).append(oPalabra.getString("ref")).append(CSS_RED_Z).append(BR);
                    sb.append(oPalabra.getString("intro")).append(BRS);
                    sb.append(utilClass.getFormato(oPalabra.getString("txt")));
                    break;
