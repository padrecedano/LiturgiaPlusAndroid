...
import static org.deiverbum.liturgiacatolica.utils.Constants.H4_URL;
...
import static org.deiverbum.liturgiacatolica.utils.Constants.VI_TITULO;
...
public class VisperasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        utilClass = new Utils();
        // TextView mTextView = findViewById(R.id.txt_breviario);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        while (keysIterator.hasNext()) {
                            ...
                            //String valueStr = keyStr.getString(keyStr);
                            Log.i(TAG, keyStr);
                        }

                        String strText = showVisperas(response);
                        strContenido = Utils.fromHtml(strText);
                        mTextView.setText(Utils.fromHtml(strText.replaceAll(SEPARADOR, "")));
...
//            Intent i = new Intent(OficioActivity.this, CalendarioActivity.class);
    ...
    protected String showVisperas(JSONObject jsonDatos) {
        Log.i(TAG, jsonDatos.toString());
        TextView textViewToChange = findViewById(R.id.txt_container);
